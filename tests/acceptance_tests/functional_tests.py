...
class FunctionalTests(TestCase):
    ...
    def test_can_cancel_delete_register(
        self,
    ):
        self.dsl.ensure_existing_register()
        self.dsl.delete_existing_register()
    ...
    def test_add_entry_name_required(
        self,
    ):
        self.dsl.ensure_existing_register()
